...
- [x] **HW-01**: Configure digital pin D2 as an INPUT pin for the SW-420 Vibration Sensor.
- [x] **HW-02**: Configure digital pin D3 as an INPUT_PULLUP pin for the SW-520D Tilt Sensor to enable the internal pull-up resistor.
- [x] **HW-03**: Configure digital pin D6 as an OUTPUT pin for the Active Buzzer.
...
- [x] **ALRT-01**: Trigger the Buzzer (D6 -> HIGH) and LED (D5 -> HIGH) immediately when Vibration (D2 reads HIGH) or Tilt (D3 reads LOW) is detected.
- [x] **ALRT-02**: Enforce a minimum holding time of 5 seconds (5000ms) for active alarms to prevent rapid pulsing/clicking of alerts.
